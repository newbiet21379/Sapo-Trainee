...
public class CategoryDAO implements CategoryDAOInterface {
    ...
    public List<Category> searchByName(String name) {
        String like = " '%" + name + "%'";
        String sql = "select * from category where name like " + like;
        List<Category> categoryList = jdbcTemplate.query(sql, new CategoryMapper(), name);
        for (Category i : categoryList
        ) {
            i.setProductList(productDAOInterface.searchByCategory(i.getId()));
        }
    ...
    public int getTotalCategory() {
        ...
        jdbcTemplate.query("select * from category", countCallback);
